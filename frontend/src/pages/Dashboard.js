    ...
    <div className="p-8" data-testid="dashboard">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card data-testid="today-sales-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-800" data-testid="today-sales-value">
        ...
        <Card data-testid="total-sales-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-800" data-testid="total-sales-value">
        ...
        <Card data-testid="total-medicines-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-800" data-testid="total-medicines-value">
        ...
        <Card data-testid="stock-value-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-800" data-testid="stock-value">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card data-testid="low-stock-alert">
          <CardHeader>
            ...
            <CardDescription>{lowStock.length} items running low</CardDescription>
          </CardHeader>
          <CardContent>
            {lowStock.length === 0 ? (
                ...
                {lowStock.slice(0, 5).map((med) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Batch: {med.batch_number}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-lg font-bold text-orange-600">{med.quantity}</p>
        ...
        <Card data-testid="expiring-soon-alert">
          <CardHeader>
            ...
            <CardDescription>{expiringSoon.length} items expiring in 30 days</CardDescription>
          </CardHeader>
          <CardContent>
