...
class Purchase(Base):
    ...
    __table_args__ = (
        ...
        Index("idx_purchases_unpaid", "pharmacy_id",
              postgresql_where=text("payment_status = 'unpaid'")),
    )
    ...
    adjusted_cn_paise: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    tcs_paise: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    extra_charges_paise: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    adjustment_amount_paise: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
