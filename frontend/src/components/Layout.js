  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2 px-3 h-14 border-b border-white/10 flex-shrink-0">
        <div className="w-7 h-7 bg-[#4682B4] rounded-md flex items-center justify-center flex-shrink-0">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="md:hidden flex items-center gap-3 px-4 h-14 bg-[#1a2332] border-b border-white/10 flex-shrink-0">
          ...
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 bg-[#4682B4] rounded flex items-center justify-center">
