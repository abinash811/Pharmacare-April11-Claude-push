...
class TestSupplierManagement:
    ...
    def test_create_supplier_success(self):
        ...
        assert created.get("is_active"), "New supplier should be active by default"
    ...
    def test_edit_supplier(self):
        ...
        update_response = self.session.put(
            f"{BASE_URL}/api/suppliers/{supplier_id}", json=update_data)
    ...
    def test_get_supplier_summary(self):
        ...
        print(
            f"✓ Supplier summary: {summary.get('total_purchases')} purchases, "
            f"₹{summary.get('total_purchase_value')} total value")
    ...
    def test_delete_supplier_blocked_if_purchases_exist(self):
        ...
        for supplier in suppliers:
            summary_resp = self.session.get(
                f"{BASE_URL}/api/suppliers/{supplier.get('id')}/summary")
        ...
        delete_response = self.session.delete(
            f"{BASE_URL}/api/suppliers/{supplier_with_purchases.get('id')}")
    ...
    def test_toggle_supplier_status(self):
        ...
        toggle_response = self.session.patch(
            f"{BASE_URL}/api/suppliers/{supplier_id}/toggle-status")
        ...
        print(
            f"✓ Toggled supplier '{supplier.get('name')}' from {original_status} to {result.get('is_active')}")
    ...
    def test_deactivated_supplier_not_in_active_only(self):
        ...
        print(
            f"✓ Deactivated supplier '{supplier.get('name')}' correctly excluded from active_only list")
