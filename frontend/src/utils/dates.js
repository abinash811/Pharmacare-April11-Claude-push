 ...
 */
export const formatDateFull = (value, fallback = '–') => formatDate(value, fallback);
 ...
 */
export const formatExpiry = (value, style = 'long') => {
  const d = toDate(value);
  if (!d) return '–';
 ...
 */
export const convertExpiryToISO = (mmyy) => {
 ...
 */
export const toExpiryMMYY = (value) => {
  const d = toDate(value);
  if (!d) return '';
 ...
 */
export const isExpiringSoon = (value, days = 90) => {
 ...
 */
export const expiryStatus = (value, days = 90) => {
...
export const expiryClassName = (value, days = 90) => {
